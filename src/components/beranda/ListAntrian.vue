<template>
  <div class="row">
    <div class="col q-pb-sm q-pr-sm q-pl-sm">
      <div>
        <q-card-section class="bg-blue-4" style="border-radius: 20px">
    ...
    <div class="col q-pb-sm q-pr-sm">
      <div>
        <q-card-section class="bg-blue-4" style="border-radius: 20px">
          ...
          <img :src="jadwal" color="orange" size="20px" class="float-right" />
          <br />
    ...
    <div class="col q-pb-sm q-pr-sm q-pl-sm">
      <div>
        <q-card-section class="bg-blue-4" style="border-radius: 20px">
          ...
          <img :src="hariIni" color="red" size="20px" class="float-right" />
          <br />
    ...
    <div class="col q-pb-sm q-pr-sm">
      <div>
        <q-card-section class="bg-blue-4" style="border-radius: 20px">
          ...
          <img :src="tersedia" color="green" size="20px" class="float-right" />
          <br />
